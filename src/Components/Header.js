...
function Header() {
    ...
    return (
        <div>
            <div
                className="h-[50px] flex flex-wrap gap-3 xxs:justify-between xs:justify-center items-center mb-16 mt-10"
                data-aos="fade-down"
                data-aos-delay="600"
            >
            ...
            <div className="lg:flex max-lg:text-center relative lg:h-[402px]">
                <div className="xl:w-[640px] xs:w-auto z-10 m-2.5">
                    ...
                    <button
                        className="bg-[#9C69E2] hover:bg-[#F063B8] hover:transition-all hover:duration-300 text-white h-[50px] w-[168px] rounded-[50px]"
                        data-aos="fade-down"
                        data-aos-delay="600"
                    >
                        Learn more
                ...
                <div className="lg:w-[700px] xs:w-full lg:absolute right-0 " data-aos="fade-up" data-aos-delay="600">
                    <img src={logo} alt="" />
                </div>
            </div>

            <div
                className="lg:flex xs:block max-lg:m-auto bg-[#f063b826] rounded-[50px] max-sm:px-10 px-20 py-10 my-20 gap-4 items-center"
                data-aos="fade-up"
            >
                <img src={logo1} alt="" data-aos="zoom-in-left" />
